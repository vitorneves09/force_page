app.controller('propostaEtapaController', function ($scope, messageService, crudServices) {
	var lastFindOptions = {};
	...
	$scope.load = function (findOptions) {
		...
		$scope.busy = crudServices.get('proposta/etapa', lastFindOptions).then(function (data) {

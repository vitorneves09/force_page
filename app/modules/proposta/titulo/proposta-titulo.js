app.controller('propostaTituloController', function ($scope, messageService, crudServices) {
	var lastFindOptions = {};
	...
	$scope.load = function (findOptions) {
		...
		$scope.busy = crudServices.get('proposta/titulo', lastFindOptions).then(function (data) {

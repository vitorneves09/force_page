app.controller('propostaDocumentoController', function ($scope, crudServices) {
	var lastFindOptions = {};
	...
	$scope.load = function (findOptions) {
		...
		$scope.busy = crudServices.get('proposta/documento', lastFindOptions).then(function (data) {

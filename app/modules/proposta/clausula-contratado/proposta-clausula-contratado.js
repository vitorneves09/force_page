app.controller('propostaClausulaContratadoController', function ($scope, messageService, crudServices) {
	var lastFindOptions = {};
	...
	$scope.load = function (findOptions) {
		...
		$scope.busy = crudServices.get('proposta/clausula-contratado', lastFindOptions).then(function (data) {

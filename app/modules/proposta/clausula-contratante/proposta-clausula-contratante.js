app.controller('propostaClausulaContratanteController', function ($scope, messageService, crudServices) {
	var lastFindOptions = {};
	...
	$scope.load = function (findOptions) {
		...
		$scope.busy = crudServices.get('proposta/clausula-contratante', lastFindOptions).then(function (data) {
